import {
    getKintoneUserCode, getKintoneUserCodesOfSetted,
...
describe("getRecordIdFromCardのテスト", () => {
    ...
    for (const {name, mockReturn, expected} of testcases) {
        test(name, async () => {
            ...
            const actual = await getRecordIdFromCard(k, "", {card: {id: ""}} as Data)
...
describe("getRecordIdFromLabelOfSameのテスト", () => {
    ...
    for (const {name, mockReturn, expected} of testcases) {
        test(name, async () => {
            ...
            const actual = await getRecordIdFromLabelOfSame(k, "", {label: {id: ""}} as Data)
            expect(actual).toEqual(expected);
        });
    }
});
...
describe("getKintoneUserCodeのテスト", () => {
    ...
    for (const {name, mockReturn, expected} of testcases) {
        test(name, async () => {
            ...
            const actual = await getKintoneUserCode(k, "", {member: {id: ""}} as Data)
            expect(actual).toEqual(expected);
        });
    }
});
...
describe("getKintoneUserCodesOfSettedのテスト", () => {
    ...
    for (const {name, mockReturn, expected} of testcases) {
        test(name, async () => {
            ...
            const actual = await getKintoneUserCodesOfSetted(k, "", {card: {id: ""}} as Data)
            expect(actual).toEqual(expected);
        });
    }
});
...
describe("getRecordIdAndLabelIdsFromCardのテスト", () => {
    ...
    for (const {name, mockReturn, expected} of testcases) {
        test(name, async () => {
            ...
            const actual = await getRecordIdAndLabelIdsFromCard(k, "", {card: {id: ""}} as Data)
            expect(actual).toEqual(expected);
        });
    }
});